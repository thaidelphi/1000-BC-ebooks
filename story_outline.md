...
#### บทที่ 12: ค่ายกลรั้วไม้ซุงและปฏิวัติการตัดไม้ข้ามหมื่นปี (The Timber Stockade, Winter Longhouse & Modern Saw Revolution)
* **Archetype:** Type B & C (Engineering, Heavy Construction, Guard Deployment & Modern Tool Culture Shock)
* **Scene Goal:** สถาปนาค่ายปราการถาวร (The Bastion Camp), ปฏิวัติการตัดไม้ด้วยเครื่องมือช่างไร้สายสมัยใหม่, สร้างเรือนไม้ซุงยาวต้านหนาวอิงผาหินปูน, และวางระบบเวรยามป้องกัน 24 ชั่วโมง สกัดกั้นภัยคุกคามจากเผ่ากินคนเขี้ยวอสูร
* **Unboxing Beat:** แกะพัสดุ `#TH-512093`:
...
* **The Forum Beat:** ธามส่งรูปแนวกำแพงไม้ซุงและเรือนพักขึ้นกระทู้: วิศวกรในบอร์ดชื่นชมการวางผังจุดบอด (Dead Angle) พร้อมเตือนเรื่องการสลับเวรยามเพื่อไม่ให้คนเฝ้าเวรแข็งตายยามค่ำคืน ขณะที่ `@BioArch_Oxford` สังเกตเห็นว่านี่คือ "ป้อมปราการยุคหินที่สร้างด้วยเทคโนโลยีข้ามเวลาหมื่นปี"
* **Resolution & Morale Boost:** ชนเผ่ากวางผามีที่พักอบอุ่นแข็งแกร่ง ไม่ต้องทนหนาวในเพิงหนังสัตว์ซอมซ่ออีกต่อไป ค่ายกลรั้วไม้ซุงและระบบเวรยามทำให้ทุกคนรู้สึกปลอดภัยอย่างที่ไม่เคยมีมาก่อนในชีวิต พร้อมรับมือภัยสงคราม Younger Dryas
* **Cargo Log:** เลื่อยโซ่ไร้สาย 21V (ใช้งาน แบตเตอรี่ก้อนที่ 1 เหลือ 60%), แบตสำรอง 1 ก้อน, สว่านกระแทกไร้สาย 20V (ใช้งาน แบตเหลือ 70%), สกรูไม้ใช้ไป 48 ตัว (เหลือ 152 ตัว), เลื่อยพับ SK5 2 ปื้น (แจกจ่ายใช้งาน), ขวานคาร์บอน (ใช้งาน), แม่แรงไฮดรอลิก 10 ตัน (ใช้งาน), สายสลิง 10 ม. (ใช้งาน)
