...
| :--- | :--- | :--- |
| **ตอนล่าสุดที่เขียนเสร็จ** | **บทที่ 12: ค่ายกลรั้วไม้ซุง ดวงตาแห่งสุริยเทพ และลำธารมังกรไผ่** | [TH: chapter_012_th.md](file:///d:/myproject1/EBOOKs/10000-BC/chapters/chapter_012_th.md) (88 บรรทัด) / [EN: chapter_012_en.md](file:///d:/myproject1/EBOOKs/10000-BC/chapters/chapter_012_en.md) (86 บรรทัด) |
| **ตอนถัดไปที่ต้องเขียน** | **บทที่ 13: ศึกช่องแคบและกับดักขวากหนาม** | การปะทะสายสืบเขี้ยวอสูรหน้าแนวกั้นค่าย การใช้ประโยชน์จากรั้วลวดหนามและระบบสปอร์ตไลต์ PIR และการสอบปากคำเชลย |
| **องก์ปัจจุบัน (Act)** | **Act 1: บทเพลงแห่งเปลวไฟและหยาดฝน (The Song of Fire and Rain)** | การสร้างปราการถาวร สถาปนาระบบประปาไม้ไผ่ โซลาร์เซลล์ และการประจันหน้าข้าศึกครั้งแรก |
| **ไทม์ไลน์ในเรื่อง** | **วันที่ 7 — เวลาประมาณ 23:30 น.** | คืนเดือนมืด ลมหนาวกรรโชก อุณหภูมิ 5°C ยอดหญ้าแข็งตัว (ปลายฤดูใบไม้ร่วงย่างเข้าต้นหนาว) |
| **ฐานที่มั่นหลัก** | Fortress Alpha (หุบเขาเกือกม้า ผาหินปูน 10,000 BC) | รถบรรทุก 10 ล้อ + รั้วไม้ซุง 3 ม. ลวดหนามหีบเพลง + เรือนไม้ซุงยาวเตา Rocket Stove + ถ้ำลับผาสวรรค์สระน้ำแร่อุ่น |
| **ประชากรในค่าย** | ธาม (Thame) + สมาชิกเผ่ากวางผา 30 ชีวิต | คูราน (หัวหน้า), เอลยา (แผลหายสนิท), ทาร่า (เด็กหญิง), โมกา (หมอผี), นักรบ 8 นาย |
| **ยอดพัสดุในตู้ทึบ** | **แกะแล้ว 16 กล่อง / คงเหลือ >99.5%** | ยอดพัสดุรวมประเมิน **~3,500 ± ชิ้น (3,000 – 4,000 กล่อง/ซอง [~3,484 กล่อง])** ยืดหยุ่นตามขนาดพัสดุ ดูรายละเอียดใน [unboxing_log.md](./unboxing_log.md) |
| **อาวุธไพ่ตาย** | ปืนพกลูกโม่ S&W .38 โครงสเตนเลส (**กระสุน 43 นัด**) | ยังไม่ได้ยิงแม้แต่นัดเดียว สงวนเด็ดขาดในกระเป๋าเสื้อโค้ตของธาม |
| **ทรัพยากรวิกฤต** | ดีเซล 198.5 ลิตร (คงที่ ไม่ได้ใช้เครื่องยนต์ มีชุดโซลาร์ 100W), แบตเตอรี่ 100%, ลมเบรก 6.6 บาร์, Amoxicillin 5 เม็ด, เกลือ 980g | ตัดยอดตรงตาม [items.md](./items.md) |
| **ความก้าวหน้าอารยธรรม** | สะพานภาษาหมื่นปี, ประปาไม้ไผ่ 80 ม., ไฟโซลาร์ 200W PIR | สถาปนาพจนานุกรมสองภาษา (Aka, Tor, Sua, Orok, Tah, Vah) สลายกำแพงการสื่อสาร |
| **วิกฤตล่าสุดที่ค้างอยู่ (Cliffhanger)** | **โคมไฟสปอร์ตไลต์โซลาร์ 200W PIR สว่างวาบจับภาพสายสืบเผ่ากินคนเขี้ยวอสูร 3 คนในระยะ 8 ม.!** | ศัตรูตาพร่ามัวฉับพลัน เอลยาน้าวสายธนูจ่อสังหาร ศึกชี้ชะตาค่ายปราการระเบิดขึ้นแล้ว |
...
จากนั้นจงเขียนบทที่ [ใส่เลขบท เช่น 13] ทั้งฉบับภาษาไทย (chapters/chapter_XXX_th.md) และภาษาอังกฤษ (chapters/chapter_XXX_en.md) ตามมาตรฐาน 80-120 บรรทัดเนื้อหาจริง 
...
| **012** | ค่ายกลรั้วไม้ซุง ดวงตาแห่งสุริยเทพ และลำธารมังกรไผ่ | The Timber Stockade, Solar Revolution & The Green Dragon Aqueduct | [TH](./chapters/chapter_012_th.md) | [EN](./chapters/chapter_012_en.md) | 88 | `#TH-512093`, `#TH-319082`, `#TH-782104`, `#TH-551029` |
| *013* | *ศึกช่องแคบและกับดักขวากหนาม* | *The Chokepoint Ambush & The Barbed Wire Trap* | *(รอเขียน)* | *(รอเขียน)* | - | *#TH-391024 (ถ่านกัมมันต์, หินลับมีด) / แหนบรถ 5160* |
