...
| 📊 **[chapters_summary.md](./chapters_summary.md)** | **สรุปเนื้อหารายตอนและสถานะปัจจุบัน (Story State Tracker):** ตาราง Master Index ครบทุกตอน + สรุปละเอียด 3 ตอนล่าสุด เพื่อประหยัด Context Tokens (ประวัติละเอียดบทที่ 1–30 เก็บใน [chapters_summary_archive.md](./chapters_summary_archive.md)) | [เปิด chapters_summary.md](file:///d:/myproject1/EBOOKs/10000-BC/chapters_summary.md) |
...
1. **พฤติกรรมและการเปิดของประตูมิติ (Periodic, Irregular & Infrequent Openings):**
   * **ประตูมิติยังเปิดเรื่อยๆ แต่ไม่บ่อย:** รอยแยกมิติ (Temporal Rift) ไม่ใช่สิ่งที่เปิดตามตารางเวลาที่ตายตัว และไม่ได้ปิดตายถาวร แต่จะกระเพื่อมเปิดขึ้นมาเรื่อยๆ เป็นระยะตลอดมหากาพย์ ทว่ามีความถี่ต่ำ (ไม่บ่อย) เกิดขึ้นตามความผันผวนของกาลอวกาศ (Spacetime Fluctuation)
   * **ความไม่แน่นอนของระยะเวลาเปิด (Unpredictable Multi-Duration Dynamics):**
     1. **รอบที่เปิดนาน (Extended Rift Window ~หลายชั่วโมง ถึง 1 – 2 วันเต็ม / 24 – 48 ชั่วโมง):** เกิดขึ้นนานๆ ครั้ง ท้องฟ้าเปิดกว้าง สัญญาณ 5G นิ่งสนิท สองโลกสามารถตั้งวอร์รูมประสานงานกันได้เต็มที่ ดาวน์โหลดคลังข้อมูลออฟไลน์ขนาดมหาศาล (Wikipedia ออฟไลน์, พิมพ์เขียวเครื่องจักร, ตำราโลหะวิทยา, การแพทย์, เกษตรกรรม)
     2. **รอบที่เปิดไม่นาน / เปิดสั้น (Flash Rift / Micro-Burst ~30 นาที – 2 ชั่วโมง):** เกิดขึ้นกะทันหันในยามคับขัน บีบให้ทำงานแข่งกับเวลา เช่น การ Video Call ปรึกษาอาจารย์แพทย์ผ่าตัดเคสด่วน (บทที่ 21) หรือการรีบกวาดดาวน์โหลดไฟล์ข้อมูลจำเป็นเฉพาะหน้า
...
flowchart TD
    ...
    B --> C[3. Dual-Language Writing<br>ร่างบท TH และ EN คู่ขนาน 120-160 บรรทัด]
...
1. **เกณฑ์ความยาวจริง (กฎข้อ 48):** แต่ละบทต้องมีความยาว **120 – 160 บรรทัดเนื้อหาจริง (ไม่นับบรรทัดว่าง)** หรือเทียบเท่า 2,200 – 3,200 คำ (~8,500 – 12,000 ตัวอักษร)
...
- รันสคริปต์หรือนับจำนวนบรรทัดเนื้อหาจริงของทั้ง `chapter_XXX_th.md` และ `chapter_XXX_en.md` ต้องอยู่ในช่วง **120 – 160 บรรทัด**
...
| :--- | :--- | :--- |
| **ตอนล่าสุดที่เขียนเสร็จ** | **บทที่ 33: คมเขี้ยวในม่านหมอกและวิกฤติตอม่อเลือด** | [TH: chapter_033_th.md](file:///d:/myproject1/EBOOKs/10000-BC/chapters/chapter_033_th.md) (145 บรรทัด) / [EN: chapter_033_en.md](file:///d:/myproject1/EBOOKs/10000-BC/chapters/chapter_033_en.md) (145 บรรทัด) |
| **ตอนถัดไปที่ต้องเขียน** | **บทที่ 34: สะพานชักหมื่นปีและรอกกว้านทะยานฟ้า** | ก่อสร้างบันไดไม้สน 15 เมตร พร้อมชานพัก 3 ระดับและสะพานชักสำเร็จ ทดสอบระบบรอกกว้านยกของ และต่อท่อน้ำแร่ร้อนลงสู่ตีนผา |
| **ทิศทางเนื้อเรื่องหลัก** | **เน้นพบเจอชนเผ่าเล็กๆ ก่อน (ยังไม่เจอวิกเตอร์)** | วิกเตอร์หนีเตลิดไปหลังทัพแตก เก็บไว้ช่วงกลางเรื่อง (Saga 3-4 บทที่ 70+) ช่วงนี้เน้นบูรณะค่าย เกษตรกรรม โลหะวิทยา และเตรียมรับมหาฤดูหนาว |
| **องก์ปัจจุบัน (Act)** | **เข้าสู่ Saga 2: วางผังปราการ สยบภัยธรรมชาติ และเสียงเพรียกจากผืนป่า** | สถาปนาสหพันธ์หุบเขาเกือกม้า, แท่นบูชาหมื่นปี, จัดระเบียบคลังพัสดุ 9 โซน, คลังข้อมูล 850GB และเครื่องมือเหล็กกล้า |
| **ไทม์ไลน์ในเรื่อง** | **เช้าตรู่วันที่ 22 (06:00 – 18:30 น.)** | อากาศ 2°C ยามเช้า ดิ่งแตะ 0°C พลบค่ำ หมอกหนาทึบ สัตว์ร้ายลอบโจมตี |
| **ฐานที่มั่นหลัก** | Fortress Alpha (หุบเขาเกือกม้า ผาหินปูน 10,000 BC) | รถบรรทุก 10 ล้อ + แท่นบูชาหมื่นปี + เรือนสุขา-ห้องอาบน้ำฝักบัวน้ำแร่อุ่น + แปลงเกษตรขั้นบันได 3 ชั้น + เตาหลอมตีเหล็ก + ฐานรากกระท่อมไม้ซุงกึ่งใต้ดินหลังแรก 4x6 ม. + เรือนเพาะชำถ้ำผาสวรรค์ 22-25°C + กังหันน้ำเพลตันผลิตไฟ 24 ชม. + ประปาไม้ไผ่ + รั้วลวดหนาม + สะพานชักตัดขาดตีนผา 3 ม. |
| **ประชากรในค่าย** | ธาม + หมอณิชา + สมาชิกเผ่ากวางผา 30 + เผ่าแกะภูเขา 12 + อดีตเชลยศึกเขี้ยวอสูร 100 คน | รวมประชากรกว่า 140 ชีวิต สถาปนาพันธสัญญาเลือดร่วมกันผ่านแท่นบูชาหมื่นปี พร้อมสู้มหาฤดูหนาว |
| **ยอดพัสดุในตู้ทึบ** | **แกะแล้ว 34 กล่อง / คงเหลือ ~3,466 กล่อง** | ยอดพัสดุรวมประเมิน **~3,500 ± ชิ้น** บทที่ 33 เบิกใช้เครื่องมือจากโซน 1 โดยไม่แกะกล่องใหม่ ดูรายละเอียดใน [unboxing_log.md](./unboxing_log.md) |
| **อาวุธไพ่ตาย** | ปืนพกลูกโม่ S&W .38 (**กระสุน 43 นัด บริสุทธิ์ 100%**) + ปืนยิงพลุ 26.5 มม. (**เหลือพลุแดง 2 นัด**) | ปืน .38 ยังไม่เคยลั่นไกแม้แต่นัดเดียว สงวนไว้ใช้ยามคับขันชี้เป็นชี้ตายสูงสุด |
| **ทรัพยากรวิกฤต** | ดีเซล 198.5L, แบตเตอรี่ 24V เต็ม (พลังน้ำ 24/7), เกลือสมุทร 8,420g, ซุปก้อน 10.0 ก้อน, โน้ตบุ๊กทำงานทั่วไป (#TH-772910), ขวานฟอร์จจิ้ง 2 เล่ม (#TH-812049), ตลับเมตร 10ม. 2 ตลับ, ระดับน้ำตอร์ปิโด, ถุงมือยาง 10 คู่, SanDisk SSD 2TB, เหล็กแหนบสปริง 5160 | ตัดยอดตรงตาม [items.md](./items.md) |
| **ความก้าวหน้าอารยธรรม** | แท่นบูชาหมื่นปี, ฐานรากกระท่อมกึ่งใต้ดินหลังแรก 4x6 ม. ลึก 50 ซม. พร้อมแนวเตา Rocket Mass Heater, ซุงสนไทกา 6 ท่อนแรก, ผัง 15 กระท่อมไม้ซุง, เรือนสุขาและห้องอาบน้ำฝักบัวน้ำแร่อุ่นส่วนตัว, ศูนย์บัญชาการโน้ตบุ๊กออฟไลน์, เตาเผาตีเหล็ก, เครื่องสูบลมคู่, หัวจอบขุดเบิกไพร 5160, ขวานโค่นไม้ฟอร์จจิ้ง | ก้าวกระโดดสู่อารยธรรมยุคเหล็ก การก่อสร้างผังเมือง และการรับมือนักล่าดึกดำบรรพ์ |
| **วิกฤตล่าสุดที่ค้างอยู่ (Cliffhanger)** | **พญาเสือเขี้ยวดาบ Smilodon ล่าถอยเข้าดงหมอกหลังเผชิญหน้า แต่ยังคงวนเวียนในอาณาเขต ขณะที่กระท่อมหลังแรกเริ่มตั้งโครงสร้าง** | การเฝ้าระวังเวรยามผสานงานก่อสร้างแข่งกับเวลาและภัยหนาว |
...
จากนั้นจงเขียนบทที่ [ใส่เลขบท เช่น 28] ทั้งฉบับภาษาไทย (chapters/chapter_XXX_th.md) และภาษาอังกฤษ (chapters/chapter_XXX_en.md) ตามมาตรฐาน 80-120 บรรทัดเนื้อหาจริง 
...
## 📜 7. สารบัญตอนทั้งหมดที่เขียนเสร็จสมบูรณ์ (Completed Chapters Vault: บทที่ 1 – 33)
...
| **016** | พลังสายน้ำแห่งรุ่งอรุณและภารกิจกู้ชีพช่องเขาตะวันตก | The Hydroelectric Dawn & Western Pass Recon | [TH](./chapters/chapter_016_th.md) | [EN](./chapters/chapter_016_en.md) | 89 | `#TH-882194` (เป้ 65L, Vibram), `#TH-559102` (หน้าไม้ 175 ปอนด์ + ลูกดอก 6 ดอก, ลูกธนู 12 ดอก) |
...
| **022** | คลังปัญญาออฟไลน์ เสียงกลองศึกมารเขี้ยว และแนวรบช่องแคบ | The Offline Archive, War Drums of Demon Fang & The Chokepoint Frontline | [TH](./chapters/chapter_022_th.md) | [EN](./chapters/chapter_022_en.md) | 92 | `#TH-618029` (พลุดอกไม้ไฟ 12 นัด, พลุสัญญาณสีแดง 4 แท่ง, โทรโข่ง 50W) |
| **023** | เงาร่างพรานป่าสนและพันธสัญญาเกลือสมุทร | The Pine Nomads and the Salt Pact | [TH](./chapters/chapter_023_th.md) | [EN](./chapters/chapter_023_en.md) | 89 | เกลือสมุทรบริสุทธิ์ (มอบ 500g), แท่งจุดไฟแมกนีเซียม 1 ชุด |
...
| **031** | รุ่งอรุณแห่งภาคสอง: การจัดระเบียบคลังพัสดุและผังค่ายสิบห้าเรือน | Dawn of Saga Two: The Grand Cargo Sorting and the Fifteen-Cabin Blueprint | [TH](./chapters/chapter_031_th.md) | [EN](./chapters/chapter_031_en.md) | 190 | `#TH-772910` (โน้ตบุ๊กทำงานทั่วไป), จัด 9 โซน, อินเวอร์เตอร์ 220V, สุขอนามัย (สบู่ แชมพู แปรง ยาสีฟัน ครีม), เปิด 3 พัสดุฉลองสุขา (ชุดลำลองคอตตอน, รองเท้าแตะยาง/ฟองน้ำ, แครกเกอร์เนย เยลลี่ผลไม้ ลูกอมนม), ชุดฝักบัวแรงดันสูง, ฝารองนั่งสุขา |
| **032** | ขวานเหล็กกล้าและไม้ซุงแรกแห่งค่ายสิบห้าเรือน | Steel Axes and the First Timber Cabins | [TH](./chapters/chapter_032_th.md) | [EN](./chapters/chapter_032_en.md) | 140 | `#TH-812049` (ขวานโค่นไม้ 2 เล่ม, ตลับเมตร 10ม. 2 ตลับ, ระดับน้ำแม่เหล็ก, ถุงมือยาง 10 คู่) |
| **033** | คมเขี้ยวในม่านหมอกและวิกฤติตอม่อเลือด | Fangs in the Mist and the Cliffside Crucible | [TH](./chapters/chapter_033_th.md) | [EN](./chapters/chapter_033_en.md) | 145 | ไม่แกะกล่องใหม่ (เบิกโซน 1), พญาเสือเขี้ยวดาบ 300 กก. ซุ่มโจมตี, ซุงทับขาตอร์กหัก, หน้าไม้ 175 ปอนด์ + ธนูยาพิษ + ชะแลงกู้ภัย 3.5 กก. ดับเบิ้ลสไตรค์, ดึงกระดูกเข้าแนวแกนในตู้คอนเทนเนอร์, สกัดทำลายทางขึ้นเดิม 3 ม., สะพานชักตัดขาดตีนผา |
