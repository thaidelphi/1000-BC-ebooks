...
| :--- | :--- | :--- |
| **ตอนล่าสุดที่เขียนเสร็จ** | **บทที่ 9: กฎเหล็กแห่งการสงวนเสบียงและปลอกกระสุนปริศนา** | [TH: chapter_009_th.md](file:///d:/myproject1/EBOOKs/10000-BC/chapters/chapter_009_th.md) (81 บรรทัด) / [EN: chapter_009_en.md](file:///d:/myproject1/EBOOKs/10000-BC/chapters/chapter_009_en.md) (82 บรรทัด) |
| **ตอนถัดไปที่ต้องเขียน** | **บทที่ 10: คืนล่าของไดร์วูล์ฟและยุทธวิธีสปอร์ตไลต์** | ดึง Outline จาก [chapters_outline.md](./chapters_outline.md#บทที่-10-คืนล่าของไดร์วูล์ฟและยุทธวิธีสปอร์ตไลต์-the-spotlight-hunt) |
...
| **ไทม์ไลน์ในเรื่อง** | **วันที่ 5 — เวลาประมาณ 22:30 น.** | คืนเดือนมืด ลมหนาวกรรโชก น้ำค้างแข็งเกาะดิน (7°C - 8°C ปลายฤดูใบไม้ร่วง) |
...
| **ยอดพัสดุในตู้ทึบ** | **แกะแล้ว 10 กล่อง / คงเหลือ >99.7%** | ยอดพัสดุรวมประเมิน **~3,500 ± ชิ้น (3,000 – 4,000 กล่อง/ซอง [~3,490 กล่อง])** ยืดหยุ่นตามขนาดพัสดุ ดูรายละเอียดใน [unboxing_log.md](./unboxing_log.md) |
...
| **วิกฤตล่าสุดที่ค้างอยู่ (Cliffhanger)** | **ฝูงหมาป่าไดร์วูล์ฟหยุดหอน และคืบคลานเงียบประชิดค่าย 40 เมตร!** | ดวงตาสีเขียวและอำพันนับสิบคู่โอบล้อมปากทางเข้าค่ายในความมืด เตรียมจู่โจมเงียบ |
...
| *010* | *คืนล่าของไดร์วูล์ฟและยุทธวิธีสปอร์ตไลต์* | *The Spotlight Hunt* | *(รอเขียน)* | *(รอเขียน)* | - | *#TH-883109 (ไฟฉายคาดศีรษะซูมได้ 2 อัน, พาราคอร์ด 50ม.)* |
