...
| :--- | :--- | :--- |
| **ตอนล่าสุดที่เขียนเสร็จ** | **บทที่ 10: คืนล่าของไดร์วูล์ฟและยุทธวิธีสปอร์ตไลต์** | [TH: chapter_010_th.md](file:///d:/myproject1/EBOOKs/10000-BC/chapters/chapter_010_th.md) (82 บรรทัด) / [EN: chapter_010_en.md](file:///d:/myproject1/EBOOKs/10000-BC/chapters/chapter_010_en.md) (82 บรรทัด) |
| **ตอนถัดไปที่ต้องเขียน** | **บทที่ 11: เสียงเขาสัตว์สงครามและคลังเหล็กแหนบ** | ดึง Outline จาก [chapters_outline.md](./chapters_outline.md#บทที่-11-เสียงเขาสัตว์สงครามและคลังเหล็กแหนบ-war-horns-and-the-leaf-spring-forge) |
...
| **ไทม์ไลน์ในเรื่อง** | **วันที่ 5 — เวลาประมาณ 23:45 น.** | คืนเดือนมืด ลมหนาวกรรโชก น้ำค้างแข็งเกาะดิน (7°C - 8°C ปลายฤดูใบไม้ร่วง) |
| **ฐานที่มั่นหลัก** | ก้นหุบเขาหินปูน ป่าสนดึกดำบรรพ์ พิกัดโบราณ 10,000 BC | รถบรรทุก 10 ล้อตู้ทึบ Hino 500 Victor ตรึงเป็นปราการกลางค่าย เสริมเพิงฟลายชีต 4x6ม. |
| **ประชากรในค่าย** | ธาม (Thame) + สมาชิกเผ่ากวางผา 30 ชีวิต | คูราน (หัวหน้า), เอลยา (พักฟื้นแผลเริ่มเดินได้), ทาร่า (เด็กหญิง), โมกา (หมอผี) |
| **ยอดพัสดุในตู้ทึบ** | **แกะแล้ว 11 กล่อง / คงเหลือ >99.6%** | ยอดพัสดุรวมประเมิน **~3,500 ± ชิ้น (3,000 – 4,000 กล่อง/ซอง [~3,489 กล่อง])** ยืดหยุ่นตามขนาดพัสดุ ดูรายละเอียดใน [unboxing_log.md](./unboxing_log.md) |
| **อาวุธไพ่ตาย** | ปืนพกลูกโม่ S&W .38 โครงสเตนเลส (**กระสุน 43 นัด**) | ยังไม่ได้ยิงแม้แต่นัดเดียว อยู่ในกระเป๋าเสื้อโค้ตของธาม |
| **ทรัพยากรวิกฤต** | ดีเซล 198.5 ลิตร, แบตเตอรี่ 24V, ลมเบรก 6.6 บาร์, Amoxicillin 6 เม็ด, เกลือ 985g | ตัดยอดตรงตาม [items.md](./items.md) |
| **วิกฤตล่าสุดที่ค้างอยู่ (Cliffhanger)** | **จ่าฝูงไดร์วูล์ฟถูกสังหาร พบปลอกคอร้อยลวดทองแดงและนกหวีดกระดูกมนุษย์ ยืนยันเป็นหมาศึกเผ่าเขี้ยวอสูร!** | เสียงเขาสัตว์สงครามดังกังวานจากยอดผาหินทมิฬระยะ 800 ม. เป็นสัญญาณศึกใหญ่ที่ใกล้เปิดฉาก |
...
จากนั้นจงเขียนบทที่ [ใส่เลขบท เช่น 10] ทั้งฉบับภาษาไทย (chapters/chapter_XXX_th.md) และภาษาอังกฤษ (chapters/chapter_XXX_en.md) ตามมาตรฐาน 80-120 บรรทัดเนื้อหาจริง 
...
| *011* | *เสียงเขาสัตว์สงครามและคลังเหล็กแหนบ* | *War Horns and the Leaf Spring Forge* | *(รอเขียน)* | *(รอเขียน)* | - | *#TH-391024 (ถ่านกัมมันต์, หินลับมีด) / แหนบรถ 5160* |
